...
{% include comment.html character="mio" comment="（正妻ポジションの葵さんを差し置いて私がサムネ……うっへっへっへ）" %}
{% include comment.html character="aoi" comment="澪ちゃん？" %}
{% include comment.html character="mio" comment="うわあっ！？　あ、葵さん！？" %}
{% include comment.html character="aoi" comment="そんなにびっくりしなくても。このオープニングもいいよねえ。いっぱい見てほしいな。" %}
...
{% include comment.html character="hatsune" comment="私の声は山岡ゆりさんよ。まさに鬼に金棒——いいえ、「須磨初音に山岡ゆり」ね。" %}
{% include comment.html character="mio" comment="私の声は桜咲千依さんです！　にゃはは。" %}
{% include comment.html character="aoi" comment="私を演じてくれるのはまゆしぃ……まゆしぃ！？　そこは吉岡茉祐さんだろ！" %}

![『さくらいろプリズム』場面カット① 登校中の葵](/assets/images/sakupri_ss_01.jpg){:loading="lazy" class="small"}
![『さくらいろプリズム』場面カット② バスケの試合](/assets/images/sakupri_ss_02.jpg){:loading="lazy" class="small"}
![『さくらいろプリズム』場面カット③ 勉強会](/assets/images/sakupri_ss_03.jpg){:loading="lazy" class="small"}
![『さくらいろプリズム』場面カット④ みんなでお出かけ](/assets/images/sakupri_ss_04.jpg){:loading="lazy" class="small"}
...
{% include comment.html character="mio" comment="いろいろやって大変そうですね。" %}
{% include comment.html character="aoi" comment="シナリオは当時もう一人のメンバーだった京（きょう）っていう人が担当だったんだって。" %}
{% include comment.html character="mio" comment="ほえー。じゃあシナリオ以外ほぼ全部ですか？　大変だ……。" %}
...
{% include comment.html character="mio" comment="赤裸々な過去が今、明かされる……！" %}
...
{% include comment.html character="aoi" comment="ストップモーション……ってことは、写真を一枚ずつ撮影したんだ。" %}
{% include comment.html character="mio" comment="とんでもない時間がかかりそうですね。" %}
{% include comment.html character="hatsune" comment="2Dと3Dの融合、みたいなのはこの頃から興味があったみたいね。" %}

![『こくせん 黒板戦争』場面カット① 火を吹くピーちゃん](/assets/images/kokusen_01.jpg){:loading="lazy" class="small"}
![『こくせん 黒板戦争』場面カット② 対峙する二人](/assets/images/kokusen_02.jpg){:loading="lazy" class="small"}
![『こくせん 黒板戦争』場面カット③ 空中に静止する二人](/assets/images/kokusen_03.jpg){:loading="lazy" class="small"}
![『こくせん 黒板戦争』場面カット④ 磁石が飛んできた](/assets/images/kokusen_04.jpg){:loading="lazy" class="small"}
...
{% include comment.html character="haruka" comment="大学の写真部ってこんな感じなんだ。" %}
{% include comment.html character="hatsune" comment="演出によってずいぶんと美化されているようだけど。" %}
{% include comment.html character="aoi" comment="でも、このPVを見て入部を決めてくれた人もいたみたいですよ。" %}
{% include comment.html character="mio" comment="さっすが監督、やりますね！" %}
...
![『uPhone』場面カット① スマホの画面に閉じ込められた男](/assets/images/uphone_01.jpg){:loading="lazy" class="small"}
![『uPhone』場面カット② 画面が傾くと世界も傾く](/assets/images/uphone_02.jpg){:loading="lazy" class="small"}
...
{% include comment.html character="mio" comment="あの『エヴァンゲリオン』の庵野秀明監督に撮った映画を観てもらって、しかも講評までもらったんですか！？　うわー、いいなー！" %}
{% include comment.html character="hatsune" comment="当時はエヴァを観たことがなくて、収録に向けて慌てて予習したそうよ。" %}
{% include comment.html character="haruka" comment="ありがたみがわかってなかったのはもったいなさすぎる。" %}
{% include comment.html character="mio" comment="ほんとですよ！　反省してください！" %}
...
![『ストリート・ラブ』場面カット① どこかで見たようなアイコン](/assets/images/street-love_01.jpg){:loading="lazy" class="small"}
![『ストリート・ラブ』場面カット② 顔が見えない少女](/assets/images/street-love_02.jpg){:loading="lazy" class="small"}
![『ストリート・ラブ』場面カット③ 通り過ぎる電車](/assets/images/street-love_03.jpg){:loading="lazy" class="small"}
![『ストリート・ラブ』場面カット④ 踏切の向こうには誰もいなかった](/assets/images/street-love_04.jpg){:loading="lazy" class="small"}
...
{% include comment.html character="haruka" comment="海が割れてる。" %}
...
{% include comment.html character="aoi" comment="私が地球を止めてやる！！！" %}
{% include comment.html character="mio" comment="ららららーらららーらららーらららー" %}
...
![『カヅノ』場面カット① おしゃれなカフェ](/assets/images/kazuno_01.jpg){:loading="lazy" class="small"}
![『カヅノ』場面カット② 崩れるグラフィック](/assets/images/kazuno_02.jpg){:loading="lazy" class="small"}
![『カヅノ』場面カット③ 主人公ヒトミ](/assets/images/kazuno_03.jpg){:loading="lazy" class="small"}
![『カヅノ』場面カット④ 主人公ヒトミ](/assets/images/kazuno_04.jpg){:loading="lazy" class="small"}
...
{% include comment.html character="mio" comment="SF×恋愛、って感じなんでしょうか？" %}
{% include comment.html character="haruka" comment="そうみたい。AIとの恋がテーマだね。" %}
{% include comment.html character="aoi" comment="この頃から恋愛ものに興味が出てきたのかな。" %}
{% include comment.html character="hatsune" comment="ちなみに撮影は本当に大変だったみたい。あちこちに許可取りをしたり、スケジュールを組んだり、車を走らせたり。あ、そういえばレンタカーをガードレールに擦ってたわね。" %}
...
[前年に引き続き](#adobe-the-take-10-make-a-masterpiece-edition-where-the-world-ends-2016)、画像を組み合わせてアートを作り上げるという趣旨でコンテストが実施されました。

[MAX CHALLENGE 2017 年 グランプリ作品発表！ #maxjapan](https://blog.adobe.com/jp/publish/2017/11/28/general-adobe-max-japan-max-challenge-2017-finalist.html)
-->
...
![『印象派の水面』場面カット② 明け方の新宿](/assets/images/suimen_02.jpg){:loading="lazy" class="small"}
![『印象派の水面』場面カット③ 雨に濡れる花](/assets/images/suimen_03.jpg){:loading="lazy" class="small"}
![『印象派の水面』場面カット④ 晴れ渡る空](/assets/images/suimen_04.jpg){:loading="lazy" class="small"}
![『印象派の水面』場面カット⑤ 印象派の水面](/assets/images/suimen_05.jpg){:loading="lazy" class="small"}

- 担当パート：監督・撮影・編集
- 使用ツール：Canon EOS 70D, Premiere Pro, After Effects

{% include comment.html character="aoi" comment="雰囲気のあるMVだね。" %}
{% include comment.html character="hatsune" comment="実写の雰囲気が今のイラストに反映されているようにも見えるわね。" %}
...
{% include comment.html character="hatsune" comment="へえ、こういうのもできるんだ。" %}
{% include comment.html character="haruka" comment="やればできる子。" %}
...
![『ゆきのせい』場面カット① 雪の中を歩く](/assets/images/yukinosei_01.jpg){:loading="lazy" class="small"}
![『ゆきのせい』場面カット② 横顔](/assets/images/yukinosei_02.jpg){:loading="lazy" class="small"}
![『ゆきのせい』場面カット③ 雪の森](/assets/images/yukinosei_03.jpg){:loading="lazy" class="small"}
![『ゆきのせい』場面カット④ 朦朧](/assets/images/yukinosei_04.jpg){:loading="lazy" class="small"}

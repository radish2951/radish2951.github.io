...
2020 年にゲーム制作サークル「[blooming spectrum（ブルーミング・スペクトル）](https://blooming-spectrum.com)」を立ち上げて初めて制作した恋愛ゲームです。
...
本当はもっと映画らしい映画をつくりたかったのですが、人数が少なく録音環境も整っていなかったため、少人数かつセリフ無しで成立するストップモーションを採用しました。

2022 年現在、YouTube で 100 万回以上再生されています。本当にありがとうございます。
...
続編の『[こくせん 黒板戦争 2](#ストップモーションアニメこくせん-黒板戦争-2-2011)』とあわせて、私のクリエイター人生における記念碑的な作品です。
...
東京工業大学 山田研究室では腸内細菌などの微生物の DNA を解析する研究を扱っています。この MV は腸内細菌について広く知ってもらうために制作されました。

ちなみに池田の卒業研究のテーマは「充足可能性問題に着想を得た微生物群集の動体解析」です。
...
楽曲のふわりとした雰囲気をそのまま映像に表現することを心がけました。
...
ももいろクローバー Z の『デモンストレーション』という曲が元ネタです。ぜひ聴いてみてください！
...
与えられた 10 枚の画像をコラージュして新たなアートを作り出す、という趣旨のコンテストでした。

世界中からいろんな人が参加することはわかっていて、クオリティでは絶対に勝てないと思ったのでストーリー性とインパクトに全振りしました。

賞品として Adobe のサブスクリプション 1 年分をいただいたのですが、当時学生だった私にとってはこの上なくありがたかったです。
...
『秒速 5 センチメートル』からめちゃくちゃ影響を受けていますが、改めて観てみると演出やカメラワークにはオリジナルのこだわりが見受けられます。
...
番組のためだけに制作したオリジナルの短編映画です。「スマホで撮る」という制約があったので、全編 iPhone で撮影しています。
...
ストップモーションと実写映像を組み合わせた不思議な世界観を演出しました。
...
前作『[黒板戦争](#ストップモーションアニメこくせん-黒板戦争-2010)』の反動からちゃんとした映画をつくろう！という話になり、
かなり力を入れて制作した作品です。
